...
public class PatchBetterNether {

	public static void registerTransformers(IClassTransformerRegistry registry) {
		registry.add("paulevs.betternether.blocks.BlockChestOfDrawers", ClassWriter.COMPUTE_MAXS | ClassWriter.COMPUTE_FRAMES, clazzNode -> {
