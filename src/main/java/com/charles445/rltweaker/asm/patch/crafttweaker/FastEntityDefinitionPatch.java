...
public class FastEntityDefinitionPatch {

	public static void registerTransformers(IClassTransformerRegistry registry) {
		registry.add("crafttweaker.mc1120.entity.MCEntity", ClassWriter.COMPUTE_FRAMES, clazzNode -> {
			MethodNode m_getDefinition = ASMUtil.find(clazzNode, "getDefinition");
