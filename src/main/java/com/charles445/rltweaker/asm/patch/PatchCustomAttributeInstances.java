...
public class PatchCustomAttributeInstances extends PatchManager {
	...
	public PatchCustomAttributeInstances() {
		...
		add(new Patch(this, "net.minecraft.entity.ai.attributes.AttributeMap", ClassWriter.COMPUTE_MAXS | ClassWriter.COMPUTE_FRAMES) {
			@Override
			public void patch(ClassNode clazzNode) {
				MethodNode m_createInstance = this.findMethodWithDesc(clazzNode, "(Lnet/minecraft/entity/ai/attributes/IAttribute;)Lnet/minecraft/entity/ai/attributes/IAttributeInstance;", "func_180376_c", "createInstance");
